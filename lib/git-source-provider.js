...
*/
function getSource(repositoryPath, repositoryOwner, repositoryName, sourceBranch, sourceVersion, clean, submodules, nestedSubmodules, fetchDepth, lfs, accessToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let gitCommandManager = yield gitCommandManager.CreateCommandManager(lfs);
    });
}
