...
function getSource(runnerWorkspacePath, repositoryPath, repositoryOwner, repositoryName, ref, commit, clean, submodules, nestedSubmodules, fetchDepth, lfs, accessToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield git.config('http.https://github.com/.extraheader', `AUTHORIZATION: basic asdf`);
...
function getCheckoutInfo(git, ref, commit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Unqualified ref, check for a matching branch or tag
            ...
            else if (yield git.tagExists(`refs/tags/${ref}`)) {
